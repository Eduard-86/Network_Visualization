...
#include "K2Node_LoadAssetForWorld.generated.h"

class FBlueprintActionDatabaseRegistrar;
class UEdGraph;

UCLASS()
class UK2Node_LoadAssetForWorld : public UK2Node
{
	GENERATED_BODY()
public:
...
UCLASS(MinimalAPI)
class UK2Node_LoadAssetClassForWorld final : public UK2Node_LoadAssetForWorld
{
	GENERATED_BODY()
public:
	// UEdGraphNode interface
