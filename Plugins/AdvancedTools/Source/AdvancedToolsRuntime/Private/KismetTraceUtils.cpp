...
FCollisionQueryParams Copied::ConfigureCollisionParams(
	FName                    TraceTag,
	bool                     bTraceComplex,
...
FCollisionObjectQueryParams Copied::ConfigureCollisionObjectParams(
...
void Copied::DrawDebugSweptSphere(
...
void Copied::DrawDebugLineTraceSingle(
	const UWorld *        World,
	const FVector &       Start,
	const FVector &       End,
...
void Copied::DrawDebugLineTraceMulti(
	const UWorld *             World,
	const FVector &            Start,
	const FVector &            End,
	EDrawDebugTrace::Type      DrawDebugType,
...
void Copied::DrawDebugBoxTraceSingle(
	const UWorld *        World,
	const FVector &       Start,
	const FVector &       End,
...
void Copied::DrawDebugBoxTraceMulti(
	const UWorld *             World,
	const FVector &            Start,
	const FVector &            End,
	const FVector              HalfSize,
...
void Copied::DrawDebugSphereTraceSingle(
	const UWorld *        World,
	const FVector &       Start,
	const FVector &       End,
	float                 Radius,
...
)
{
	if (DrawDebugType != EDrawDebugTrace::None)
	{
		...
		{
			// no hit means all red
			Copied::DrawDebugSweptSphere(World, Start, End, Radius, TraceColor.ToFColor(true), bPersistent, LifeTime);
		}
	}
}

void Copied::DrawDebugSphereTraceMulti(
	const UWorld *             World,
	const FVector &            Start,
	const FVector &            End,
	float                      Radius,
...
void Copied::DrawDebugCapsuleTraceSingle(
	const UWorld *        World,
	const FVector &       Start,
	const FVector &       End,
	const FQuat &         Rot,
...
void Copied::DrawDebugCapsuleTraceMulti(
	const UWorld *             World,
	const FVector &            Start,
	const FVector &            End,
	const FQuat &              Rot,
